...
# Load libraries
The first step in any analysis is the load the packages you will need for your analysis. Loading packages allow you to use powerful functions not included in "base" R.

For this analysis, you will use the tidyverse package, which actually loads a group of useful packages including tidyr, dplyr, and ggplot2. You will also use Lubridate, which helps dealing with dates and times.
```{r}
library(tidyverse) 
