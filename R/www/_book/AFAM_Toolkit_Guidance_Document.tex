...
If you do not have the AFAM Toolkit dashboard installed on your
computer, you should first install R and R Studio on your computer using
...
\NormalTok{list.of.packages <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"tidyverse"}\NormalTok{, }\StringTok{"gridExtra"}\NormalTok{, }\StringTok{"pander"}\NormalTok{, }\StringTok{"shiny"}\NormalTok{, }\StringTok{"DT"}\NormalTok{,}\StringTok{"devtools"}\NormalTok{)}
